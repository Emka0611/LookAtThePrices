...
import com.emka.lookattheprices.tables.ProductTable;
...
public class ProductsDataSource
{
	...
	{
		Log.d("DEBUG","Product deleted with id: " + productId);
		database.delete(ProductTable.TABLE_PRODUCT, ProductTable.COLUMN_ID + " = " + productId, null);
	}

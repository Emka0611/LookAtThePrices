...
import com.emka.lookattheprices.tables.BarcodeTable;
...
public class BarcodesDataSource
{
	...
	public void deleteBarcode(Barcode barcode)
	{
		...
		Log.d("DEBUG","Barcode deleted with id: " + id);
	...
	public void deleteBarcodes(long productId)
	{
		List<Barcode> list = getAllBarcodes(productId);
		
		for( int i = 0; i<list.size(); i++)
		{
			deleteBarcode(list.get(i));
		}

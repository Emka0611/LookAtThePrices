...
public class DatabaseDataSources
{
	...
	public static void deleteProduct(long productId)
	{
		...
		open();
		barcodesDataSource.deleteBarcodes(productId);
		open();
		pricesDataSource.deletePrices(productId);
	}
	...
	public static List<Barcode> getAllBarcodes(long selectedProductId)
	{
		return barcodesDataSource.getAllBarcodes(selectedProductId);
	}
